...
public class Paintable : MonoBehaviour {
    ...
    public void SaveMaskToTexture() {
        ...
        hasBeenPainted = true;
        // In your SaveMaskToTexture() method, replace the file saving part with:

        //#if UNITY_EDITOR
        //        // Optional: Auto-save asset in Editor
        //        if (autoSaveTexture) {
        //            try {
        //                string directoryPath = Application.dataPath + "/SavedMasks/";
        ...
        //                string filename = gameObject.name + "_Mask.png";
        ...
        //                Debug.Log("Mask saved to: " + fullPath);
        //            }
